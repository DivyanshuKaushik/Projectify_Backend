...
router.post("/student/grade/:studentId", _auth.isFaculty, _student.default.grade);
router.put("/student/grade/update/:id", _auth.isFaculty, _student.default.updateGrade);
